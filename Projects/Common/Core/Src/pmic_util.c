...
static const pmic_data_t pmic_database[PMIC_MAX] =
{
  ...
  {PMIC_SUPPORTED,     0x20, 42, "25", 0x90, 0x8E, 0x8F},    /* PMIC_STPMIC25 */
  {PMIC_NOT_SUPPORTED, 0x30, 42, "2L", 0x90, 0x8E, 0x8F}, /* PMIC_STPMIC2L Estimated: may change */
  {PMIC_NOT_SUPPORTED, 0x10, 42, "1L", 0x90, 0x8E, 0x8F}, /* PMIC_STPMIC1L Estimated: may change */
};
#else
static const pmic_data_t pmic_database[PMIC_MAX] =
{
